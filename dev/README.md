...
## CSS
The file you want to edit is in `/boot/config/plugins/unraid-folderview/styles`, it's plain CSS, so you will need to know CSS before doing something.
...
You can find the default styles here, ([Dashboard](../src/unraid-folderview/usr/local/emhttp/plugins/unraid-folderview/styles/dashboard.css), [Docker](../src/unraid-folderview/usr/local/emhttp/plugins/unraid-folderview/styles/docker.css), [VMs](../src/unraid-folderview/usr/local/emhttp/plugins/unraid-folderview/styles/vm.css)).

This is it, have fun.

## JS
The file you want to edit is in `/boot/config/plugins/unraid-folderview/scripts`, it's plain JavaScript, so you will need to know JavaScript before doing something.
